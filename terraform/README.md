...
```
curl "https://nubesgen.com/jhipster-demo.zip?iactool=TERRAFORM&region=francecentral&application=FUNCTION.consumption&runtime=SPRING&database=POSTGRESQL.basic&addons=application_insights,key_vault,storage_blob,redis,cosmosdb_mongodb&gitops=true" | tar -xzvf -
```
